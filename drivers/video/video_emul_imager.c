...
#define DT_DRV_COMPAT zephyr_emul_imager
...
static const struct emul_imager_reg emul_imager_bggr8_64x20[] = {
	{EMUL_IMAGER_REG_TIMING1, 0x64},
	{EMUL_IMAGER_REG_TIMING2, 0x20},
	{0},
};
static const struct emul_imager_reg emul_imager_bggr8_64x20_15fps[] = {
	{EMUL_IMAGER_REG_TIMING3, 15},
	{0},
};
static const struct emul_imager_reg emul_imager_bggr8_64x20_30fps[] = {
	{EMUL_IMAGER_REG_TIMING3, 30},
	{0},
};
struct emul_imager_mode emul_imager_bggr8_64x20_modes[] = {
	{.fps = 15, .regs = {emul_imager_bggr8_64x20, emul_imager_bggr8_64x20_15fps}},
	{.fps = 30, .regs = {emul_imager_bggr8_64x20, emul_imager_bggr8_64x20_30fps}},
	{0},
};

static const struct emul_imager_reg emul_imager_bggr8_64x32[] = {
	{EMUL_IMAGER_REG_TIMING1, 0x64},
	{EMUL_IMAGER_REG_TIMING2, 0x32},
	{0},
};
static const struct emul_imager_reg emul_imager_bggr8_64x32_15fps[] = {
	{EMUL_IMAGER_REG_TIMING3, 15},
	{0},
};
struct emul_imager_mode emul_imager_bggr8_64x32_modes[] = {
	{.fps = 15, .regs = {emul_imager_bggr8_64x32, emul_imager_bggr8_64x32_15fps}},
	{0},
};
...
static const struct emul_imager_mode *emul_imager_modes[] = {
	[BGGR8_64x20] = emul_imager_bggr8_64x20_modes,
	[BGGR8_64x32] = emul_imager_bggr8_64x32_modes,
...
static const struct video_format_cap fmts[] = {
	[BGGR8_64x20] = EMUL_IMAGER_VIDEO_FORMAT_CAP(64, 20, VIDEO_PIX_FMT_BGGR8),
	[BGGR8_64x32] = EMUL_IMAGER_VIDEO_FORMAT_CAP(64, 32, VIDEO_PIX_FMT_BGGR8),
...
static int emul_imager_set_ctrl(const struct device *dev, unsigned int cid, void *value)
{
	...
	case VIDEO_CID_CAMERA_TEST_PATTERN:
		return emul_imager_read_reg(dev, EMUL_IMAGER_REG_PATTERN, value);
	default:
		return -ENOTSUP;
	}
}
...
static int emul_imager_get_ctrl(const struct device *dev, unsigned int cid, void *value)
{
	...
	switch (cid) {
	case VIDEO_CID_CAMERA_EXPOSURE:
		return emul_imager_read_reg(dev, EMUL_IMAGER_REG_EXPOSURE, value);
	case VIDEO_CID_CAMERA_GAIN:
		return emul_imager_read_reg(dev, EMUL_IMAGER_REG_GAIN, value);
	case VIDEO_CID_CAMERA_TEST_PATTERN:
		return emul_imager_read_reg(dev, EMUL_IMAGER_REG_PATTERN, value);
