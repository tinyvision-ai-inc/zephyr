...
/** Uncompressed and Motion-JPEG Video Frame Descriptors (continuous) */
struct uvc_frame_descriptor_continuous {
	uint8_t bLength;
	uint8_t bDescriptorType;
	uint8_t bDescriptorSubtype;
	uint8_t bFrameIndex;
...
/** Uncompressed and Motion-JPEG Video Frame Descriptors (discrete) */
#define STRUCT_UVC_FRAME_DESCRIPTOR_DISCRETE(n)                                                    \
	struct uvc_frame_descriptor_discrete_##n {                                                 \
		uint8_t bLength;                                                                   \
		uint8_t bDescriptorType;                                                           \
		uint8_t bDescriptorSubtype;                                                        \
		uint8_t bFrameIndex;                                                               \
...
STRUCT_UVC_FRAME_DESCRIPTOR_DISCRETE(1)
STRUCT_UVC_FRAME_DESCRIPTOR_DISCRETE(2)
STRUCT_UVC_FRAME_DESCRIPTOR_DISCRETE(3)
