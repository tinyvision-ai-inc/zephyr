...
/**
 * @brief Define an 3x3 identity kernel operation for RGB24 data.
 *
...
/**
 * @brief Define an 5x5 identity kernel operation for RGB24 data.
...
/**
 * @brief Define an 3x3 sharpen kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
...
/**
 * @brief Define an 3x3 edgedetect kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
...
/**
 * @brief Define an 3x3 gaussianblur kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
...
/**
 * @brief Define an 5x5 unsharp kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
...
/**
 * @brief Define an 3x3 median kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
...
/**
 * @brief Define an 5x5 median kernel operation for RGB24 data.
 * @copydetails PIXEL_RGGB8STREAM_TO_RGB24STREAM_3X3()
 */
