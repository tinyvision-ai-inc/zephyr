				    ...
				    struct gpio_callback *cb, uint32_t pins)
{
	...
	const struct lsm6dsr_config *cfg = lsm6dsr->dev->config;
...
#endif /* CONFIG_LSM6DSR_TRIGGER_OWN_THREAD */
}
...
static void lsm6dsr_thread(void *p1, void *p2, void *p3)
{
	...
	struct lsm6dsr_data *lsm6dsr = p1;
...
#endif /* CONFIG_LSM6DSR_TRIGGER_GLOBAL_THREAD */
